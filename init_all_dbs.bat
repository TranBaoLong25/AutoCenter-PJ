...
echo "=== 8. KHOI TAO VEHICLE SERVICE ==="
docker-compose exec vehicle-service flask db init
docker-compose exec vehicle-service flask db migrate -m "Initial vehicle service tables"
docker-compose exec vehicle-service flask db upgrade

echo "=== 9. KHOI TAO AFTER SALE SERVICE ==="
docker-compose exec aftersale-service flask db init
docker-compose exec aftersale-service flask db migrate -m "Initial aftersale service tables"
docker-compose exec aftersale-service flask db upgrade
